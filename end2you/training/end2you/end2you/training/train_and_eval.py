...
class TrainEval(Train):
    ...
    def __init__(self, *args, **kwargs):
        ...
        self.save_dir = Path(self.train_dir) / 'top_saved_model'
    ...
    def _eval_and_sum(self, sess, eval_pred, eval_labs, eval_sids,
        ...
        print('\n End of evaluation. Mean {}:  {}'.format(self.metric, total_eval))
    ...
    def start_training(self):
        ...
        with tf.Session(config=config) as sess:
            ...
            tf_eval_sum = tf.summary.scalar('eval/total_eval', tf.convert_to_tensor(eval_sum))
            
            get_eval_once = EvalOnce.get_eval_tensors(
                sess, self.predictions, self.data_provider, self.tfrecords_eval_folder)
            ...
            for epoch in range(self.num_epochs):
                ...
                with open(str(self.save_dir / "models_performance.txt"), "w") as csvfile:
